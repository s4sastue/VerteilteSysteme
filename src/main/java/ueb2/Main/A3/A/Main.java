package ueb2.Main.A3.A;

import org.oxoo2a.sim4da.Simulator;
import ueb2.MessageCounter.MessageCounter;
import ueb2.MessageCounter.VectorMessageCounter;
...
/**
 * Main executable for experiment of task 3 (use of the vector method)
 */
public class Main {
    public static void main(String[] args) {
        ...
        MessageCounter messageCounterType = new VectorMessageCounter(null);
